...
public class MedicamentoController {
	...
	public ResponseEntity<Medicamento> actualizaAlumno(@RequestBody Medicamento obj){
		if(obj == null) {
			...
			if(optMedicamento.isPresent()) {
				Medicamento objActualizado = service.insertaActualizaMedicamento(obj);
	...
	@ResponseBody
	public ResponseEntity<List<Medicamento>> listaMedicamentoPorStock(@PathVariable("paramStock")String stock){
